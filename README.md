...
254 obras em domínio público, em EPUB e PDF, prontas para o Kindle, para a impressão e para qualquer leitor.
...
254 obras também em PDF (A5, composição do instituto, com página de procedência), hospedados em biblioteca.aeviternitas.com; o link de cada um está na ficha (`pdf`) e no OPDS.
